...
**County:** Pinellas County, FL. **FIPS 12003.** GIS tax-parcel polygons ≈ **311,584**
...
| GIS REST | 311,584 polygons | count + mixed USE_CODE queries succeeded | 1–2 (maxRecord 1k–15k; page with `resultOffset`) | Minutes | **Bulk / seed.** |
