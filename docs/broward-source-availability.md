...
coverage still requires bounded vendor-specific pilots and city routing. The
five Accela adapters above are local/private staging only and are not wired to
AWS ingestion or publication.
