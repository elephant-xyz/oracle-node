...
function mapLandUseToPropertyType(landUseDescription) {
  ...
  if (desc.includes('MANUFACTURED HOME SUB') || desc.includes('MANUFACTURED SUB')) return 'ManufacturedHousing';
  if (desc.includes('MANUFACTURED HOME') && !desc.includes('SUB')) return 'MobileHome';
  if (desc.includes('MULTI FAMILY >9') || desc.includes('MULTI FAMILY >=10')) return 'MultipleFamily';
  if (desc.includes('MULTI FAMILY <5') || desc.includes('MULTI FAMILY >4 AND <10') || desc.includes('MULTI FAMILY <=9')) return 'TwoToFourFamily';
  ...
  if (desc.includes('RESIDENTIAL COMMON ELEMENTS') || desc.includes('COMMON ELEMENTS')) return 'ResidentialCommonElementsAreas';
