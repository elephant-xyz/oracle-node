 ...
 * @property {string | null} transformedOutputS3Uri - S3 URI of the transformed output zip (null if validation failed)
      ...
      if (runError instanceof Error && runError.name === "ValidationFailure") {
        ...
        try {
          ...
          if (result.saved) {
            ...
            // Return with null transformedOutputS3Uri to signal validation failure
            return {
              status: "success",
